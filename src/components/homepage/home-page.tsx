			...
			<div className="container my-20 max-w-5xl">
				<div className={'flex flex-col lg:flex-row gap-10 items-center'}>
					...
					<div className={'flex flex-col gap-4'}>
						<p className={'font-bold text-3xl'}>Ngoccoder</p>
						<p className={''}>Tôi là Ngọc, chuyên môn chính là làm website. Project này hoàn toàn free, bạn có thể check source code của nó <Link className={'text-indigo-600 underline'} href={'https://github.com/nuhoangcodon99/download-images-by-urls'} target={'_blank'}>tại đây</Link> </p>
						<div className={'flex flex-wrap gap-2'}>
							<Link href={'https://www.youtube.com/@'} className={badgeVariants({ variant: "secondary" })}>Youtube</Link>
							<Link href={'https://www.facebook.com/bengokyeuanh.99/'} className={badgeVariants({ variant: "secondary" })}>Facebook</Link>
							<Link href={'https://github.com/nuhoangcodon99/'} className={badgeVariants({ variant: "secondary" })}>Github</Link>
						</div>
					</div>
				</div>
			</div>
